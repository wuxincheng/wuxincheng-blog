				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li <c:if test="${'blog' eq navFlag}">class="active"</c:if>><a href="<%=request.getContextPath()%>/blog/list"><i class="fa fa-home"></i> 博客</a></li>
						</ul>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li <c:if test="${'about' eq navFlag}">class="active"</c:if>><a href="<%=request.getContextPath()%>/about/"><i class="fa fa-bell"></i> 关于我们</a></li>
						</ul>
					</div>
				</div>
			</nav>
